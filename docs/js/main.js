...
var WorldComponent = /*#__PURE__*/function (_Component) {
  ...
  */
  ...
  _proto.createScene = function createScene() {
    ...
    var mainLight = new THREE.PointLight(0xffffff, 1); //(0xffffff)

    mainLight.position.set(-50, 0, -50);
    objects.add(mainLight);
    var light2 = new THREE.DirectionalLight(0xffffff, 1); //0xffe699 1.5

    light2.position.set(40, -40, 40);
    light2.target.position.set(0, 0, 0);
    objects.add(light2);
    var light3 = new THREE.DirectionalLight(0xffffff, 0.5); //(0xffe699, 1)
